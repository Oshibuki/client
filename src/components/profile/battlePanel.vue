            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="info-box bg-default-light">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-text">{{ seasonStatusStore.BKills }} <small>KILLS</small></span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="info-box bg-default-light">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-text">{{ seasonStatusStore.BTeamkills }} <small>TEAMKILLS</small></span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="info-box bg-default-light">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-text">{{ seasonStatusStore.BDeaths }}<small>DEATHS</small></span>
                    </div>
                </div>
            </div>
